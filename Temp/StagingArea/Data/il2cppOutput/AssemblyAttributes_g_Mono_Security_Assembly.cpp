...
void g_Mono_Security_Assembly_CustomAttributesCacheGenerator(CustomAttributesCache* cache)
{
	cache->attributes = (Il2CppObject**)il2cpp_gc_alloc_fixed(sizeof(t5 *) * cache->count, 0);
	{
		...
		m2695(tmp, il2cpp_codegen_string_new_wrapper("(c) 2003-2004 Various Authors"), &m2695_MI);
	...
	}
	{
		...
		m2694(tmp, il2cpp_codegen_string_new_wrapper("MONO CLI"), &m2694_MI);
		cache->attributes[2] = (Il2CppObject*)tmp;
	}
	{
		t568 * tmp;
		tmp = (t568 *)il2cpp_codegen_object_new (&t568_TI);
		m2690(tmp, il2cpp_codegen_string_new_wrapper("Mono.Security.dll"), &m2690_MI);
