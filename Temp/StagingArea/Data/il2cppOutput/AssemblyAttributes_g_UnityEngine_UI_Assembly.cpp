...
void g_UnityEngine_UI_Assembly_CustomAttributesCacheGenerator(CustomAttributesCache* cache)
{
	cache->attributes = (Il2CppObject**)il2cpp_gc_alloc_fixed(sizeof(t5 *) * cache->count, 0);
	{
		...
		m2690(tmp, il2cpp_codegen_string_new_wrapper("guisystem"), &m2690_MI);
		cache->attributes[0] = (Il2CppObject*)tmp;
	}
	{
		t569 * tmp;
		tmp = (t569 *)il2cpp_codegen_object_new (&t569_TI);
		m2691(tmp, il2cpp_codegen_string_new_wrapper(""), &m2691_MI);
	...
	}
	{
		...
		m2693(tmp, il2cpp_codegen_string_new_wrapper("Microsoft"), &m2693_MI);
		cache->attributes[3] = (Il2CppObject*)tmp;
	}
	{
		t572 * tmp;
		tmp = (t572 *)il2cpp_codegen_object_new (&t572_TI);
		m2694(tmp, il2cpp_codegen_string_new_wrapper("guisystem"), &m2694_MI);
		cache->attributes[4] = (Il2CppObject*)tmp;
	}
	{
		t573 * tmp;
		tmp = (t573 *)il2cpp_codegen_object_new (&t573_TI);
		m2695(tmp, il2cpp_codegen_string_new_wrapper("Copyright © Microsoft 2013"), &m2695_MI);
	...
	}
	{
		...
		m2696(tmp, il2cpp_codegen_string_new_wrapper("1.0.0.0"), &m2696_MI);
		cache->attributes[7] = (Il2CppObject*)tmp;
	}
	{
		t575 * tmp;
		tmp = (t575 *)il2cpp_codegen_object_new (&t575_TI);
		m2697(tmp, il2cpp_codegen_string_new_wrapper("d4f464c7-9b15-460d-b4bc-2cacd1c1df73"), &m2697_MI);
	...
	}
	{
		...
		m2699(tmp, il2cpp_codegen_string_new_wrapper(""), &m2699_MI);
