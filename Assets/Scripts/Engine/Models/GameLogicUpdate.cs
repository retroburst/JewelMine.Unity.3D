...
namespace JewelMine.Engine.Models
{
	...
	public class GameLogicUpdate
	{
		...
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="JewelMine.Engine.Models.GameLogicUpdate"/> game restarted.
		/// </summary>
		/// <value><c>true</c> if game restarted; otherwise, <c>false</c>.</value>
		public bool GameWasRestarted { get; set; }
